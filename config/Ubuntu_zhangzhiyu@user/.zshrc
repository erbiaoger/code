...
# specfem
export GLOBE=~/MyProjects/Seisflows/specfem3d_globe
export PATH=$PATH:$GLOBE/bin



# 映射 
alias sf='seisflows'
alias par='seisflows par'
alias Par='seisflows sempar -P DATA/Par_file'
alias md='mkdir -p'
...
alias vz='vim ~/.zshrc'
alias la='exa -lm --icons --time-style=long-iso -a'
alias ls='exa -lm --icons --time-style=long-iso '
...
__conda_setup="$('/home/zhangzhiyu/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/zhangzhiyu/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/zhangzhiyu/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/zhangzhiyu/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
