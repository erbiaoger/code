...
c.NotebookApp.token = 'zhangzhiyu'
...
#  Choices: any of ['sha3_512', 'sha3_256', 'sha384', 'sha512', 'sha3_224', 'sha256', 'sha1', 'sha224', 'blake2b', 'blake2s', 'md5', 'sha3_384']
#  Default: 'sha256'
