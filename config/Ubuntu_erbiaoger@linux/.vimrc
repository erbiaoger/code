...
autocmd Filetype markdown inoremap <buffer> <silent> jb **** <++><Esc>F*hi
autocmd Filetype markdown inoremap <buffer> <silent> jx ~~~~ <++><Esc>F~hi
autocmd Filetype markdown inoremap <buffer> <silent> jx ** <++><Esc>F*i
...
autocmd Filetype markdown inoremap <buffer> <silent> jt <Esc>F]i
